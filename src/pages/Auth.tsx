...
const Auth = () => {
  ...
  if (showSplash) {
    return (
      <div 
        className={`flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-primary via-accent to-fun-yellow transition-opacity duration-500 ${splashFading ? 'opacity-0' : 'opacity-100'}`}
      >
        <img 
          src={toonreelsLogo} 
          alt="ToonReels" 
